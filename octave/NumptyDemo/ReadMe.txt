...
This software module is a simple 866MHz ASCII/BPSK transceiver example for education purposes with the LimeSDR.  It runs using Octave, an open source numerical package that provides a relatively easy programming environment for communication systems.

NumptyText1.m simple conversion of ASCII to BPSK, no error correction.  Synchroniser carrys out simple phase correction.

NumptyText2.m simple conversion of ASCII to BPSK with BCH(7,4) error correction.  Synchroniser carrys out simple phase correction.

NumptyText3.m simple spread spectrum version (CDMA) of ASCII to BPSK with BCH(7,4) error correction.  Scaled pilot channel is used for frame synchronisation and is quadrature to data.  Pilot channel is then removed from received data.
...
run NumptyText1.m % to execute the BPSK Demo

run NumptyText2.m % to execute the BPSK/FEC Demo

run NumptyText3.m % to execute the BPSK/FEC/CDMA Demo
