...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Simple ASCII to BPSK data link with BCH Error Correction
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% run NumptyText2.m
...
bpskData=[sync,2*encBinData-1]; % convert binary to BPSK, attach Sync word
...
% 
  ...
  for cc=1:(msgLen*osr*2)
    decData=iqDataRx(cc:osr:(cc+osr*length(sync)-1));
  ...
  NumptyGraphs(fpltname,iqDataTx,iqDataRxRaw,iqDataRx,binData,din,doutDec,FSR,osr,msgLen,saveGraphs);
